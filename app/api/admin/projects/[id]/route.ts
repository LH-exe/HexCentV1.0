...
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  try {
    const project = await prisma.project.update({ where: { id }, data: { ...(body.slug !== undefined && { slug: body.slug.trim().toLowerCase() }), ...(body.title !== undefined && { title: body.title }), ...(body.description !== undefined && { description: body.description }), ...(body.icon !== undefined && { icon: body.icon }), ...(body.iconColor !== undefined && { iconColor: body.iconColor }), ...(body.titleColor !== undefined && { titleColor: body.titleColor }), ...(body.summaryColor !== undefined && { summaryColor: body.summaryColor }), ...(body.status !== undefined && { status: body.status }), ...(body.tags !== undefined && { tags: body.tags }), ...(body.content !== undefined && { content: body.content }), ...(body.isPublic !== undefined && { isPublic: body.isPublic }), ...(body.order !== undefined && { order: body.order }) } });
